...
#ifndef INCLUDED_FLEX_OFDM_INSERT_PREAMBLE_H
#define INCLUDED_FLEX_OFDM_INSERT_PREAMBLE_H

#include <gr_block.h>
#include <vector>

class flex_ofdm_insert_preamble;
typedef boost::shared_ptr<flex_ofdm_insert_preamble> flex_ofdm_insert_preamble_sptr;
...
{
  friend flex_ofdm_insert_preamble_sptr
  flex_make_ofdm_insert_preamble(int fft_length,
			       const std::vector<std::vector<gr_complex> > &preamble);
...
#endif /* INCLUDED_FLEX_OFDM_INSERT_PREAMBLE_H */
